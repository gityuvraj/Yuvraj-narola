...
jQuery('#contact_submit').on('touchstart click',function(e){
	...
	jQuery("#contact_submit").parent().after("<div class='validation custom-error' >One or more fields have an error. Please check and try again.</div>");
...
jQuery("#contact_submit").parent().after("<div class='validation custom-success'>Thank you!</div>");
}
